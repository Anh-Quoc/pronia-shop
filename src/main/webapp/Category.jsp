...
<head>
    ...
    <title>Category Table Manager</title>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a href="admin-categories?command=READ"> <h2>Manage <b>Category</b></h2> </a>
                    </div>
                    <div class="col-sm-6">
...
<div id="editCategoryModal_<%=category.getId()%>" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="admin-categories" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="categoryName" class="form-control" value="<%=category.getName()%>" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
