...
<head>
    ...
    <title>OrderDetail Table Manager</title>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <%--                    <div class="col-sm-6">--%>
                    <%--                        <a href="#addOrderModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Tag</span></a>--%>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <% List<OrderDetailDTO> listOrderDetails = (List<OrderDetailDTO>) request.getAttribute("listOrderDetails");%>
                ...
                <tr>
                    ...
                    <td><%=orderDetail.getId()%>
                    </td>
                    <td><%=orderDetail.getProductId()%>
                    </td>
                    ...
                    <td><%=orderDetail.getSubtotal()%>
                    </td>
                    <td><%=orderDetail.getOrderId()%>
                    </td>

                    <%--                    <td>--%>
                    <%--                        <a href="#editTagModal_<%=tag.getId()%>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>--%>
                    <%--                        <a href="#deleteTagModal_<%=tag.getId()%>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>--%>
                    <%--                    </td>--%>
                </tr>
                <% } %>
                <% } %>
...
<%--</div>--%>
<!-- Delete Modal HTML -->
<%--<div id="deleteTagModal_<%=tag.getId()%>" class="modal fade">--%>
<%--    <div class="modal-dialog">--%>
<%--        <div class="modal-content">--%>
<%--            <form>--%>
<%--                <div class="modal-header">--%>
