...
<%--                                <%-- error message    --%>
                                    <% String wrongConfirmPassword = (String) request.getAttribute("wrongConfirmPassword"); %>
                                    <%    if (wrongConfirmPassword != null && !wrongConfirmPassword.isEmpty()) { %>
                                    <h6 style="color: red"><%=wrongConfirmPassword%></h6>
                                    <%}%>
                                    <div class="col-12">
                                        <button
