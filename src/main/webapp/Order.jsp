...
<head>
    ...
    <title>Order Table Manager</title>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <a href="admin-orders?command=READ"><h2>Manage <b>Order</b></h2></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                <% List<OrderDTO> listOrders = (List<OrderDTO>) request.getAttribute("listOrders");%>
                ...
                <tr>
                    ...
                    <td><%=order.getStreetAddress()%>
                    </td>
                    <td><%=order.getApartment()%>
                    </td>
                    <td><%=order.getCity()%>
                    </td>
                    ...
                    <td><a href="admin-orderDetails?command=READ&orderId=<%=order.getId()%>"> View </a></td>

                    <td><%=order.getOrderStatus().getName()%>
                    </td>
                    <td><%=order.getCustomerId()%>
                    </td>
